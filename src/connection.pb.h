...
extern VersionControlResultDefaultTypeInternal _VersionControlResult_default_instance_;
}  // namespace db_connection
PROTOBUF_NAMESPACE_OPEN
...
template<> ::db_connection::VersionControlResult* Arena::CreateMaybeMessage<::db_connection::VersionControlResult>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace db_connection {
...
class VersionControlResult final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:db_connection.VersionControlResult) */ {
 public:
  inline VersionControlResult() : VersionControlResult(nullptr) {}
  ~VersionControlResult() override;
  explicit PROTOBUF_CONSTEXPR VersionControlResult(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  VersionControlResult(const VersionControlResult& from);
  VersionControlResult(VersionControlResult&& from) noexcept
    : VersionControlResult() {
    *this = ::std::move(from);
  }

  inline VersionControlResult& operator=(const VersionControlResult& from) {
    CopyFrom(from);
    return *this;
  }
  inline VersionControlResult& operator=(VersionControlResult&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const VersionControlResult& default_instance() {
    return *internal_default_instance();
  }
  static inline const VersionControlResult* internal_default_instance() {
    return reinterpret_cast<const VersionControlResult*>(
               &_VersionControlResult_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(VersionControlResult& a, VersionControlResult& b) {
    a.Swap(&b);
  }
  inline void Swap(VersionControlResult* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(VersionControlResult* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  VersionControlResult* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<VersionControlResult>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const VersionControlResult& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const VersionControlResult& from) {
    VersionControlResult::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(VersionControlResult* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "db_connection.VersionControlResult";
  }
  protected:
  explicit VersionControlResult(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:db_connection.VersionControlResult)
 private:
  class _Internal;
...
// string message = 2;
inline void VersionControlResult::clear_message() {
  _impl_.message_.ClearToEmpty();
}
inline const std::string& VersionControlResult::message() const {
  // @@protoc_insertion_point(field_get:db_connection.VersionControlResult.message)
  return _internal_message();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void VersionControlResult::set_message(ArgT0&& arg0, ArgT... args) {
 
 _impl_.message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:db_connection.VersionControlResult.message)
}
inline std::string* VersionControlResult::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:db_connection.VersionControlResult.message)
  return _s;
}
inline const std::string& VersionControlResult::_internal_message() const {
  return _impl_.message_.Get();
}
inline void VersionControlResult::_internal_set_message(const std::string& value) {
  
  _impl_.message_.Set(value, GetArenaForAllocation());
}
inline std::string* VersionControlResult::_internal_mutable_message() {
  
  return _impl_.message_.Mutable(GetArenaForAllocation());
}
inline std::string* VersionControlResult::release_message() {
  // @@protoc_insertion_point(field_release:db_connection.VersionControlResult.message)
  return _impl_.message_.Release();
}
inline void VersionControlResult::set_allocated_message(std::string* message) {
  if (message != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:db_connection.VersionControlResult.message)
}
